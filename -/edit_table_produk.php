        	...
        	<div class="col-12 d-flex flex-row flex-wrap justify-content-center">
            	<div class="col-12 d-flex flex-row flex-wrap">
                	...
                	<form method="post" autocomplete="off" enctype="multipart/form-data" action="simpan_table_produk.php" class="col-12 d-flex flex-row flex-wrap justify-content-center">
                        ...
                        <div class="col-8">
                            <input class="col-lg-6 col-md-9 col-12 p-0" type="text" name="nama_produk" value="<?php echo $data["nama_produk"];?>" required/>
                        </div>
                        <div class="col-4 clwhite">
                            <h3 class="walt m-0 float-right">Harga Produk</h3>
                        </div>
                        <div class="col-8">
                            <input class="col-lg-6 col-md-9 col-12 p-0" type="text" name="harga_produk" value="<?php echo $data["harga_produk"];?>" required/>
                        </div>
                        <div class="col-4 clwhite">
                        ...
                        <div class="col-8">
                            ...
                            <select name="tipe_produk" id="tipe_produk">
                                ...
                                <option value="minuman" <?php echo($data["tipe_produk"]=="minuman") ?  "selected":"" ;?> >Minuman</option>
                                <option value="pudding" <?php echo($data["tipe_produk"]=="pudding") ?  "selected":"" ;?> >Pudding</option>
                            </select>
                        </div>
